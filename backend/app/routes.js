...
router.post("/api/login", userProfileUpload, controller.eserLogin);
router.get("/api/users-list/:id", controller.userLogin);
...
router.post("/api/upload-image-file", imageMsgFileUpload, controller.uploadImagFile);
